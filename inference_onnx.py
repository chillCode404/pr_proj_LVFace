...
if __name__ == "__main__":
    # Example usage
    model_path = "models/LVFace-T_Glint360K.onnx"  # Update with your model path
    inferencer = LVFaceONNXInferencer(model_path, use_gpu=True)

    # Example 1: Inference from local image
    try:
        img_path = "./data/example_img_Taylor_Swift.png"  # Update with your image path
    ...
    try:
        ...
        img_url = "https://media.baovanhoa.vn/zoom/1000/uploaded/nghiemthanh/2025_08_12/1_XVNU.png"
